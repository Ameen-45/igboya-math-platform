  ...
  const sections = [
    {
      ...
      path: '/topics/calculus/introduction',
      color: '#EF4444',
      duration: '20 min'
    },
    {
      icon: '🔍',
      title: 'Examples',
      description: 'Explore step-by-step solved calculus problems and applications.',
      path: '/topics/calculus/examples',
      color: '#DC2626',
      duration: '25 min'
    },
    {
      ...
      description: 'Practice calculus problems with guided hints and instant feedback.',
      path: '/topics/calculus/practice',
      color: '#B91C1C',
      duration: '30 min'
    },
    {
      icon: '📝',
      title: 'Quiz',
      description: 'Test your calculus knowledge with interactive quizzes.',
      path: '/topics/calculus/quiz',
      color: '#F59E0B',
      duration: '20 min'
    }
  ];
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        right: 0,
        bottom: 0,
        backgroundImage: `radial-gradient(circle at 20% 30%, rgba(239, 68, 68, 0.03) 0%, transparent 50%),
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px', fontSize: '14px', color: '#64748B', flexWrap: 'wrap' }}>
          ...
          <span>›</span>
          <span style={{ color: '#EF4444', fontWeight: '500' }}>Calculus</span>
        </div>
        ...
        <div style={{ textAlign: 'center', marginBottom: isMobile ? '32px' : '48px' }}>
          ...
          <p style={{
            ...
            Master limits, derivatives, integrals, and their real-world applications.
          </p>
        </div>
          ...
          <div style={{ maxWidth: '400px', margin: '0 auto' }}>
            ...
            <div style={{ marginTop: '16px' }}>
              <span style={{
                ...
                {progress === 100 ? '🎉 You mastered Calculus!' : `🎯 ${sections.length} sections to explore`}
              </span>
            </div>
          </div>
        </div>

...
export default function Algebra() {
  ...
  const progress = 25 // This would come from localStorage in a real app
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px', fontSize: '14px', color: '#64748B', flexWrap: 'wrap' }}>
          ...
          <span>›</span>
          <span style={{ color: '#6366F1', fontWeight: '500' }}>Algebra</span>
        </div>
          ...
          <div style={{ maxWidth: '400px', margin: '0 auto' }}>
            ...
            <div style={{ marginTop: '16px' }}>
              <span style={{
                ...
                {progress === 100 ? '🎉 You mastered Algebra!' : `🎯 ${5 - Math.ceil((progress / 100) * 5)} sections remaining`}
              </span>
            </div>
          </div>
        </div>
